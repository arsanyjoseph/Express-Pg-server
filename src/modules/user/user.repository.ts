...
export class UserRepository {
    ...
    async createUser(user: UserDto): Promise<UserDto> {
        ...
        if (foundUsers.length > 0) throw new Error("This Email is already registered")
        ...
        const query = {
            ...
            values: [firstName, lastName, email, hashedPassword, UserRoles.STUDENT, new Date().toISOString(), new Date().toISOString(), true, null],
        };
        try {
